...
echo "🚀 Sirius Group - ИДЕАЛЬНАЯ настройка сервера"
echo "=============================================="
...
# 12. Запуск сервера с МИНИМАЛЬНЫМ рабочим main.py
echo "📋 12. Запуск сервера с минимальным рабочим main.py..."
nohup python3 -m uvicorn app.main_minimal_working:app --host 0.0.0.0 --port 8000 > server.log 2>&1 &
...
echo "=============================================="
echo "🎉 ИДЕАЛЬНАЯ НАСТРОЙКА ЗАВЕРШЕНА!"
echo "🚀 Сервер работает с минимальным рабочим main.py"
